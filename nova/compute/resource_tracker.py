...
class ResourceTracker(object):
    ...
    def _get_traits(self, nodename, provider_tree=None):
        ...
        # Now get the capabilities off the driver and add any supported
        # traits that are missing, and remove any existing set traits that
    ...
    def _update_to_placement(self, context, compute_node, startup):
        ...
        try:
            ...
            # CUSTOM_VENDOR_TRAIT_X set externally on the provider -
            # we can't touch that.
