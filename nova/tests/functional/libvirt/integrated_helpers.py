...
class LibvirtProviderUsageBaseTestCase(
    ...
    :param init_host: boolean representing whether the test case needs
    to test the init_host() code path. Defaults to False.
    """
    ...
    def setUp(self):
        ...
        self.pre_start_compute()
        self.start_compute()

    def pre_start_compute(self):
        """Subclasses can override this in order to do extra stuff
        before starting the compute service.
        """
        pass
